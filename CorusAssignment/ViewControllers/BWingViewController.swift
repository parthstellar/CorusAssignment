...
class BWingViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {

    @IBOutlet weak var tblView: UITableView!

    var arrSections: [SectionModel] = [
        SectionModel(strScreenName: "B WING", strSectionName: "201", arrProfile: [
            ProfileModel(strName: "Rahul Singh", strDesignation: "", strDesignationInfo: "", strInfo: "", isBookmarked: false, img: #imageLiteral(resourceName: "rectangle-3_2x")),
            ProfileModel(strName: "Chandni Wong", strDesignation: "", strDesignationInfo: "Holistic healer \nFAITH MIRACLES WELLNESS", strInfo: "Push yourself, because no one else is going to do it for you.", isBookmarked: false, img: #imageLiteral(resourceName: "rectangle-3-1_2x"))
        ]),
        SectionModel(strScreenName: "B WING", strSectionName: "202", arrProfile: [
            ProfileModel(strName: "Sarah Duke", strDesignation: "", strDesignationInfo: "", strInfo: "", isBookmarked: false, img: #imageLiteral(resourceName: "rectangle-3-2_2x")),
            ProfileModel(strName: "Dominique Carlton", strDesignation: "", strDesignationInfo: "", strInfo: "", isBookmarked: false, img: #imageLiteral(resourceName: "rectangle-3-3_3x")),
        ])
...
//        return arrSections[section].strSectionName
//    }
